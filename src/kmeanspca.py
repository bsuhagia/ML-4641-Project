...
test = pd.read_csv("newdata/A.csv")
test2 = np.array(test)
i = 1
for line in f.readlines():
	...
	if line == 'A':
		continue
	print("newdata/" + line + ".csv")
	temp = pd.read_csv("newdata/" + line + ".csv")
	temp = np.array(temp)
	temp2 = temp[2:, :]
...
plt.scatter(centroids[:, 0], centroids[:, 1],
            ...
            color='w', zorder=10)
plt.title('K-means clustering (5 years, 18 companies) (PCA-reduced data)\n'
